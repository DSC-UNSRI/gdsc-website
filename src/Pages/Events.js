...
function Events() {
    ...
    return (
        <div>
            ...
            <section className="text-gray-900 lg:bg-white relative overflow-x-hidden mt-10 xl:mt-12 pb-24">
                ...
                <div className="mx-24 2xl:mx-28 mt-16 items-center justify-between relative gap-8 xl:gap-16 mb-5 xl:mb-8">
                    <div className="flex flex-row text-gray-800 pb-16 xl:pb-20 2xl:pb-24">
                        ...
                        <div className="flex flex-col w-4/5 items-center xl:-ml-4 2xl:-ml-6">
                            <img src="/event/webinar1.png" className="py-4 w-full xl:w-5/6 2xl:w-4/5 pr-16 2xl:pr-10" alt="" />
                        </div>
                        <div className="flex flex-col w-3/5 justify-start text-justify py-2 2xl:ml-10">
                            <h2 className="font-semibold text-xl xl:text-2xl 2xl:text-3xl">Start Your Machine Learning</h2>
                    ...
                    <div className="flex flex-row text-gray-800 pb-16 xl:pb-20 2xl:pb-24">
                        <div className="flex flex-col justify-start pr-6 text-center">
                            <h3 className="font-medium text-lg xl:text-xl 2xl:text-2xl">March</h3>
                            <h1 className="font-bold text-4xl xl:text-5xl 2xl:text-5xl">28</h1>
                        </div>
                        <div className="flex flex-col w-4/5 items-center xl:-ml-4 2xl:-ml-6">
                            <img src="/event/webinar1.png" className="py-2 w-full xl:w-5/6 2xl:w-4/5 pr-16 2xl:pr-10" alt="" />
                        </div>
                        <div className="flex flex-col w-3/5 justify-start text-justify py-2 2xl:ml-10">
                            <h2 className="font-semibold text-xl xl:text-2xl 2xl:text-3xl">Start Your Machine Learning</h2>
                            <h3 className="font font-medium text-sm xl:text-base 2xl:text-lg pb-4">Machine Learning</h3>
                    ...
                    <div className="flex flex-row text-gray-800 pb-16 xl:pb-20 2xl:pb-24">
                        <div className="flex flex-col justify-start pr-6 text-center">
                            <h3 className="font-medium text-lg xl:text-xl 2xl:text-2xl">April</h3>
                            <h1 className="font-bold text-4xl xl:text-5xl 2xl:text-5xl">01</h1>
                        </div>
                        <div className="flex flex-col w-4/5 items-center xl:-ml-4 2xl:-ml-6">
                            <img src="/event/webinar1.png" className="py-2 w-full xl:w-5/6 2xl:w-4/5 pr-16 2xl:pr-10" alt="" />
                        </div>
                    ...
                    <div className="flex flex-row text-gray-800 pb-16 xl:pb-20 2xl:pb-24">
                        <div className="flex flex-col justify-start pr-6 text-center">
                            <h3 className="font-medium text-lg xl:text-xl 2xl:text-2xl">April</h3>
                            <h1 className="font-bold text-4xl xl:text-5xl 2xl:text-5xl">16</h1>
                        </div>
                        <div className="flex flex-col w-4/5 items-center xl:-ml-4 2xl:-ml-6">
                            <img src="/event/webinar1.png" className="py-2 w-full xl:w-5/6 2xl:w-4/5 pr-16 2xl:pr-10" alt="" />
                        </div>
